...
class FeachTopRatedItem extends StatefulWidget {
  Results results;
  ...
  @override
  State<FeachTopRatedItem> createState() => _FeachTopRatedItemState();
}

class _FeachTopRatedItemState extends State<FeachTopRatedItem> {
  @override
